...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      {isLoading ? (
        <div className="fixed inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
                    ...
                    <div className="hidden lg:block mb-6">
                      ...
                      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 mb-6 border border-blue-100">
                        ...
                        <p className="text-gray-700 leading-relaxed">
                          {user?.bioDescription ||
                            "Tell us about yourself and what makes you unique. Share your passion, goals, and what you love to do."}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        onClick={() => {
                          const carousel =
                            document.getElementById("contacts-carousel");
...
const DetailsCard = ({ heading, details, gradientClass }) => {
  return (
    <Card className="border-gray-200 bg-white/80 backdrop-blur-sm shadow-lg">
      <div className="mb-4">
        <h3
          className={`text-xl font-bold bg-gradient-to-r ${gradientClass} bg-clip-text text-transparent mb-2`}
        >
          {heading}
        </h3>
        <div
          className={`h-1 w-16 bg-gradient-to-r ${gradientClass} rounded-full`}
        ></div>
      </div>
    ...
    <div className="group relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 rounded-2xl p-4 border border-gray-200/60 hover:border-blue-300/60 transition-all duration-300 hover:shadow-lg backdrop-blur-sm">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-gray-600 font-medium">{work}</p>
        </div>
